...
app.get ('/',function(req,res){
    res.send("hello it is my irst express application")
})
app.get('/about', function(req,res){
    res.send("This is a baic express application")
})
...
app.listen (5000,function(){console.log("server is runningpn port 5000")})